...
import { Flex, Grid, Box, Text, Button, EthereumPowIcon, ErrorIcon, useTooltip, Skeleton } from '@pancakeswap/uikit'
...
const SetPriceStage: React.FC<React.PropsWithChildren<SetPriceStageProps>> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>{t('%percentage%% trading fee will be used to buy & burn MINE', { percentage: tradingFee })}</Text>
    </>,
    { placement: 'auto' },
  )
    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        <Flex>
          <Flex flex="1" alignItems="center">
            <EthereumPowIcon width={24} height={24} mr="4px" />
            <Text bold>WBNB</Text>
          </Flex>
          <Flex flex="2">
            <RightAlignedInput
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WBNB. You can swap WBNB to BNB 1:1 for free with MineSwap.')}
          </Text>
        </Box>
      </Grid>
      <Divider />

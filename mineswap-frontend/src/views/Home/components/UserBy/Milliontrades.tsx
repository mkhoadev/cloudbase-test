    ...
    <div className="div-millions-user">
          ...
          <div className="sc-jOiSOi gIUHqg">
            <div className="sc-iAEawV eojyCN">
              <div className="sc-eeMvmM jKblIE">
                ...
                <img src="/img/swirlcurl@2x.png" alt="swirlcurl" className="sc-hAQmFe hpkbds"></img>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="sc-eblUpn kAIfLV">
        <div className="sc-eOSrOQ hpiEQ">
          <span className="inter-black-alto-32px">20 million </span>
          <span className="sc-inNIpp hWpUlW" style={{color:'var(--inchworm)'}}>trades</span>
        </div>

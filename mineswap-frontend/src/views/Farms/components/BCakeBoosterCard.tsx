...
export const useBCakeTooltipContent = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking MINE in the fixed-term staking MINE pool. The more MINE you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
      <Box>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active fixed-term MINE staking position is required for activating farm yield boosters.')}
        </Text>

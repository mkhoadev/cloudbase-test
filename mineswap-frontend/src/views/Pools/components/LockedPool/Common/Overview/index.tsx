  ...
  return (
    <>
      <Box>
        ...
        <LightGreyCard>
          <BalanceRow title={t('Mine to be locked')} value={lockedAmount} newValue={newLockedAmount} decimals={2} />
      ...
      {showLockWarning && (
        <Box mt="16px" maxWidth="370px">
          <Message variant="warning">
            <MessageText>
              {t('You will be able to withdraw the staked MINE and profit only when the staking position is unlocked')}
            </MessageText>
          </Message>
        </Box>
      )}

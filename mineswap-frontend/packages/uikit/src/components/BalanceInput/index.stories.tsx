...
export const SwitchUnits: React.FC<React.PropsWithChildren> = () => {
  const CAKE_PRICE = 69;
  const [editingUnit, setEditingUnit] = useState<"MINE" | "USD">("MINE");
  const conversionUnit = editingUnit === "MINE" ? "USD" : "MINE";
  ...
  const switchEditingUnits = () => {
    const editingUnitAfterChange = editingUnit === "MINE" ? "USD" : "MINE";

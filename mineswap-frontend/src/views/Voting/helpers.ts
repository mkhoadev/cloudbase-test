...
const STRATEGIES = [
  { name: 'cake', params: { symbol: 'CAKE', address: ethereumTokens.weth.address, decimals: 18, max: 300 } },
]
const NETWORK = '56'
...
const nodeRealProvider = new JsonRpcProvider('https://mainnet.ethereumpow.org', 10001)

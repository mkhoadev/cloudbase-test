  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on MinSwap.'),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by MinSwap from sales are used to buy back and BURN MINE tokens in our weekly MINE burns.',
        ),
        t(

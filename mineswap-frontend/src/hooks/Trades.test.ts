...
describe('Trade', () => {
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(ethereumTokens.weth, '1'), new TokenAmount(ethereumTokens.weth, '1'))],
  //         [PairState.INVALID, new Pair(new TokenAmount(ethereumTokens.busd, '1'), new TokenAmount(ethereumTokens.weth, '1'))],
  //         [PairState.LOADING, new Pair(new TokenAmount(ethereumTokens.busd, '1'), new TokenAmount(ethereumTokens.weth, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(ethereumTokens.weth, ethereumTokens.weth)
  //         return {
  //           pairs,
  //         }
  //       })
  //       expect(result.current.pairs).toStrictEqual([
  //         new Pair(new TokenAmount(ethereumTokens.weth, '1'), new TokenAmount(ethereumTokens.weth, '1')),
  //       ])
  //     })
  ...
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(ethereumTokens.weth, ethereumTokens.weth)
  //       })
  ...
  //       const allowPairs = [new Pair(new TokenAmount(ethereumTokens.weth, '1'), new TokenAmount(ethereumTokens.weth, '1'))]
  //       const argA = CurrencyAmount.ether('1000000')
  //       const argB = ethereumTokens.weth
  //       renderHook(
  //         () => {

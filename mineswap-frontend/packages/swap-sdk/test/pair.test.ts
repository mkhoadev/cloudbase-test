...
describe('Pair', () => {
  const USDC = new Token(ChainId.BASE, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.BASE, '0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3', 18, 'DAI', 'DAI Stablecoin')
      ...
      expect(
        () =>
          new Pair(
            ...
            CurrencyAmount.fromRawAmount(WNATIVE[ChainId.BASE_GOERLI], '100')
          )
      ).toThrow('CHAIN_IDS')
    })
  })
  ...
  describe('#priceOf', () => {
    ...
    it('throws if invalid token', () => {
      expect(() => pair.priceOf(WNATIVE[ChainId.BASE])).toThrow('TOKEN')
    })
  })

  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active MineSwap Profile to buy Minting Tickets and mint a MineSwapSquad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold MINE'),
      bodyText: [t('Each NFT costs MINE to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” MineSwapBunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active MineSwapProfile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a MineSwapSquad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (

...
// 40 MINE is minted per block
// 20 MINE per block is sent to Burn pool (A farm just for burning cake)
// 10 MINE per block goes to MINE syrup pool
// 9 MINE per block goes to Yield farms and lottery
...
export const BASE_URL = 'https://mineswap.finance'

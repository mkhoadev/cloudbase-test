...
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/hoaflee/block'
...
export const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BASE]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth',
}

export const BLOCKS_CLIENT_WITH_CHAIN = {
  [ChainId.BASE]: 'https://api.thegraph.com/subgraphs/name/blocklytics/ethereum-blocks',
}

...
import { SUPPORT_ONLY_ETHW } from 'config/constants/supportChains'
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_ETHW }: { pageSupportedChains?: number[] }) => {

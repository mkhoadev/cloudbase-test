...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the MineSwapSquad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 MineSwapBunny NFTs at the snapshot may also purchase one additional MineSwapSquad NFT in the presale for each MineSwapBunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of MINE spent on MineSwapSquad NFTs will be burned as part of our weekly MINE burn.')],
  },
  {

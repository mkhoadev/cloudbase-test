import { BIT_QUERY, INFO_CLIENT, STABLESWAP_SUBGRAPH_CLIENT, INFO_CLIENT_ETH, INFO_CLIENT_GOERLI } from 'config/constants/endpoints'
...
export const infoClienGOERLI = new GraphQLClient(INFO_CLIENT_GOERLI)

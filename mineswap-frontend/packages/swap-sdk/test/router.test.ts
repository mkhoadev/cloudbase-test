...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(
    CurrencyAmount.fromRawAmount(WNATIVE[ChainId.BASE], '1000'),
    ...
    describe('exact in', () => {
      it('ether to token1', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x51',
          [WNATIVE[ChainId.BASE].address, token0.address, token1.address],
      ...
      it('token1 to ether', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
          [token1.address, token0.address, WNATIVE[ChainId.BASE].address],
          '0x0000000000000000000000000000000000000004',
        ])

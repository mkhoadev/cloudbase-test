...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        MINE up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active MineSwap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active MineSwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The MINE from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of MINE to either sale.</Trans>,
      <Trans>
